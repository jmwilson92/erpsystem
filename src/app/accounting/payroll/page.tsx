...
export default async function PayrollPage() {
  ...
  if (!canRun && !(await userHasPermission(user.id, "accounting.view"))) {
    notFound();
  }
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Payroll"
        description="Run payroll from approved timecards. This is the only place payroll is processed — it posts the accrual journals to the GL."
        actions={
