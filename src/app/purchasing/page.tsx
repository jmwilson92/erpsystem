...
import { ShoppingCart, FileInput, PackageCheck, Filter, X } from "lucide-react";
...
export default async function PurchasingPage({
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Purchasing"
        description="Filter purchase requests and orders — receiving is on Receiving Travelers"
        actions={
          <Link href="/receiving">
      ...
      >
        ...
        <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6">
          <div>
            <label className="text-[10px] uppercase text-slate-600">Search</label>
            <Input
              name="q"
              defaultValue={q}
              placeholder={tab === "pos" ? "PO #, vendor, notes…" : "PR #, vendor, reason…"}
