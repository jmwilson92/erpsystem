...
export const PLANS = [
  ...
  },
  {
    ...
    price: 8400,
    interval: "year",
    blurb: "Growing manufacturers — priority support, up to 50 users.",
    seats: 50,
  },
  {
    key: "BUSINESS",
    ...
    price: 18000,
    interval: "year",
    blurb: "Multi-site + custom modules, up to 150 users.",
    seats: 150,
  },
  {
    key: "ENTERPRISE",
    ...
    price: 0,
    interval: "year",
    blurb: "151+ users — bespoke modules, SSO, self-host, SLA. Let's talk.",
    seats: null,
  },
] as const;
