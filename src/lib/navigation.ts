...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/quality/programs", label: "Quality Programs", icon: Shield, keywords: ["qms", "program", "compliance", "as9100"] },
      { href: "/quality/programs/calibration", label: "Calibration", icon: Ruler, keywords: ["gage", "gauge", "cal", "metrology", "mte", "instrument", "due"] },
      { href: "/quality/programs/tools", label: "Tool Control", icon: Wrench, keywords: ["tooling", "tool crib", "accountability", "inspection"] },
      { href: "/quality/programs/hazmat", label: "HAZMAT", icon: FlaskConical, keywords: ["hazardous", "sds", "msds", "chemical", "storage", "disposal"] },
      { href: "/quality/programs/esd", label: "ESD Control", icon: Zap, keywords: ["electrostatic", "wrist strap", "mat", "ansi esd s20.20"] },
      { href: "/quality/programs/fod", label: "FOD Prevention", icon: ScanEye, keywords: ["foreign object", "debris", "damage", "walk", "as9146"] },
      { href: "/quality/programs/safety", label: "Safety / EHS", icon: ShieldAlert, keywords: ["ehs", "osha", "ppe", "extinguisher", "eyewash", "incident"] },
      { href: "/quality/programs/training", label: "Training & Certs", icon: GraduationCap, keywords: ["qualification", "certification", "competency", "expiry"] },
      { href: "/quality/programs/audits", label: "Internal Audits", icon: ClipboardList, keywords: ["audit", "as9101", "finding", "schedule"] },
      { href: "/quality/programs/counterfeit", label: "Counterfeit Parts", icon: SearchCheck, keywords: ["counterfeit", "suspect", "as5553", "as6174", "verification"] },
    ],
  },
  {
