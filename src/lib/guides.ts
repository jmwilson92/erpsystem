    ...
    steps: [
      {
        ...
        body: "Each row is a return authorization — receive the unit and route it to MRB or a repair work order. The RMA links back to the original order and serial.",
        placement: "top",
      },
      {
        route: "/trace/serials",
        ...
        body: "Pick a serial to walk its genealogy — the as-built tree, the lots and sub-serials that went into it, and every test and disposition it touched.",
    ...
    steps: [
      {
        ...
        body: "Programs and portfolios group the projects beneath them, each with a work-breakdown structure and earned-value metrics (SPI/CPI) — schedule and cost performance at a glance.",
        placement: "top",
      },
      {
        route: "/pmo/pi",
      ...
      {
        route: "/pmo/alerts",
        selector: '[data-tour="pm-alerts"]',
        title: "PM alerts",
        body: "Unread program risks and threshold breaches surface here (and on the bell) so a slipping program gets attention early.",
        placement: "top",
      },
      {
        route: "/budgets",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        title: "Banking & payroll are tabs here",
        body: "Switch areas from this bar. Banking links accounts via Plaid to pull transactions and reconcile against the ledger; Payroll runs gross-to-net from approved timesheets.",
    ...
    steps: [
      {
        ...
        title: "HR & Workforce",
        body: "Reviews, goals, training & certifications, time off, documents, and feedback live across these tabs — your workspace, plus team and company views for managers and HR. Recruiting and Onboarding open from the buttons up top.",
        placement: "bottom",
      },
      {
        route: "/recruiting",
        ...
        body: "Open a job requisition, add candidates, and move them Applied → Screening → Interview → Offer → Hired. Moving a candidate to Hired opens their onboarding record automatically — no re-keying.",
        placement: "top",
      },
      {
        route: "/hr/onboarding",
        ...
        body: "Each new hire's record holds personal info, IDs, a documents checklist (I-9, W-4, direct deposit), and background checks — with a completion gate before day one.",
        placement: "top",
      },
    ],
  },
  ...
  // ──────────────────────────── Administration ─────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Company-wide preferences — identity and letterhead, fiscal year, accounting basis, and the toggles that shape how modules behave.",
        placement: "bottom",
      },
      {
        ...
        body: "Role-based access control — decide who can see and do what, module by module, and handle access requests.",
      ...
      },
      {
        ...
        title: "Data Import",
        body: "Bring your item master and other data in from CSV/Excel with the guided wizard — migrate quickly instead of hand-keying.",
        placement: "top",
      },
      {
        route: "/email",
